...
from terane.api.source import DescribeSourceRequest
from terane.loggers import getLogger

logger = getLogger('terane.toolbox.admin.source.show')

class ShowSourceCommand(AdminCommand):
    """
    """
    ...
    def run(self):
        ...
        request = DescribeSourceRequest(self.name)
